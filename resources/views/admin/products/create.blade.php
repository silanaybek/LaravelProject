            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Ürün adı">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control" rows="4" placeholder="Ürün açıklaması">{{ old('description') }}</textarea>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="discount_price" class="form-control" value="{{ old('discount_price') }}" step="0.01" min="0" placeholder="Boş bırakın">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="form-group" id="sizes-group" style="display:none;">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            @php $clothingSizes = ['XS','S','M','L','XL','XXL']; $shoeSizes = ['36','37','38','39','40','41','42','43','44']; @endphp
                            <div id="clothing-sizes">
                                <p class="text-muted small mb-1">Giyim Bedenleri:</p>
                                @foreach($clothingSizes as $sz)
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" class="custom-control-input" id="sz_{{ $sz }}" name="sizes[]" value="{{ $sz }}" {{ in_array($sz, old('sizes', [])) ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="sz_{{ $sz }}">{{ $sz }}</label>
                                </div>
                                @endforeach
                            </div>
                            <div id="shoe-sizes" class="mt-2">
                                <p class="text-muted small mb-1">Ayakkabı Numaraları:</p>
                                @foreach($shoeSizes as $sz)
                                <div class="custom-control custom-checkbox custom-control-inline">
                                    <input type="checkbox" class="custom-control-input" id="sz_shoe_{{ $sz }}" name="sizes[]" value="{{ $sz }}" {{ in_array($sz, old('sizes', [])) ? 'checked' : '' }}>
